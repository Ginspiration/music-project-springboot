                ...
                <div class="box box-widget">
                    <div class="box-header with-border">
                        <div class="user-block">
                            <img class="img-circle" src="<%=basePath%>static/img/user1-128x128.jpg" alt="User Image">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <img class="img-responsive pad" src="<%=basePath%>static/img/photo2.png" alt="Photo">
                    ...
                    <div class="box-footer box-comments">
                        ...
                        <div class="box-comment">
                            <!-- User image -->
                            <img class="img-circle img-sm" src="<%=basePath%>static/img/user4-128x128.jpg"
                                 alt="User Image">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-widget">
                    ...
                    <div class="box-body">
                        ...
                        <p>the coast of the Semantics, a large language ocean. A small river named Duden flows by their
                            place and supplies it with the necessary regelialia. It is a paradisematic country, in which
                            roasted parts of sentences fly into your mouth.</p>

                        <!-- Attachment -->
                        <div class="attachment-block clearfix">
                            <img class="attachment-img" src="<%=basePath%>static/img/photo1.png" alt="Attachment Image">
